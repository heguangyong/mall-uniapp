			...
			<view class="header">
				<view class="serch-wrapper acea-row">
					...
					<navigator v-if="hotWords.length > 0" :url="'/pages/goods/goods_search/index?searchVal='+searchVal"
						:style="[searchBoxStyle]" :class="logoConfig&&!isSmallPage ? 'input' : logoConfig&&isSmallPage?'uninput-new':!logoConfig&&!isSmallPage?'uninput':'maxInput'" hover-class="none"
						class="input">
					...
					<navigator v-else :style="[searchBoxStyle]" :class="logoConfig&&!isSmallPage ? 'input' : logoConfig&&isSmallPage?'uninput-new':!logoConfig&&!isSmallPage?'uninput':'maxInput'"
				...
				<!-- #endif -->
					<view class="serch-wrapper acea-row">
						...
						<navigator v-if="hotWords.length > 0" 
							...
							hover-class="none" class="input" :class="logoConfig&&!isSmallPage ? 'input' : logoConfig&&isSmallPage?'uninput-new':!logoConfig&&!isSmallPage?'uninput':'maxInput'">
